...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://uq1ef4yrzc.execute-api.us-east-1.amazonaws.com/dev4';
    ...
    apigClient.uploadPut = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        console.log("customLabelsadditionalParams: " + additionalParams.headers);
        apiGateway.core.utils.assertParametersDefined(additionalParams.headers, ['x-amz-meta-customLabels'], ['body']);
        //apiGateway.core.utils.assertParametersDefined(params, ['custom_labels', 'x-amz-meta-customLabels'], ['body']);
        ...
        var uploadPutRequest = {
            ...
            queryParams: apiGateway.core.utils.parseParametersToObject(params, ['custom_labels', ]),
            body: body
        };
